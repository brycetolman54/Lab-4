#ifndef LAB_4_PATHFINDER_H
#define LAB_4_PATHFINDER_H
...
private:
    ...
    static const int DEP = 5;
    int currentMaze[COL][ROW][DEP];
...
public:
    ...
    */
    ...
    //-----------------------------------------------------------------------------------------
    bool findPath(int maze[COL][ROW][DEP], int x, int y, int z);
    void switchVector();
};

#endif //LAB_4_PATHFINDER_H
